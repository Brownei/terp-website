...
const DEFAULTS = {
    "morocco-1": {
        ...
        accountContract: "terp142kvnl56hs7jacmwysswlhp4f4eyt7ljclcy9ak7v3cgg3ldhzzs6ye4vu",
        configAccount: "",
    },
    "120u-1": {
        rest: "http://localhost:1317",
        accountContract: "terp1v7spuu4j7xu3eddfzzmnm4j37vmsqll775hgga93hy0wcyezhhgqtvcsag",
        configAccount: "",
    },
};
...
function detectChainId() {
    return location.hostname === "localhost" ? "120u-1" : "morocco-1";
}
...
export async function loadSiteConfig(defaults) {
    ...
    try {
        ...
        if (res.ok) {
            ...
            // Expose checksums for installer verification
